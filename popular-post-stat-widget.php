...
class Post_Stats_Counter extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_class', 'description' => __('Widget to display popular posts', 'awp'));
		$control_ops = array('width' => 200, 'height' => 250);
		parent::__construct(false, $name = __('AWP Popular Posts', 'awp'), $widget_ops, $control_ops );
		?>
		<?php
	}
	function form($instance) {
		$defaults = array( 'title' => __('Popular Posts', 'awp'), 'post_count' => __('5'),'sort_radio'=>'0','featured-image'=>'0','post-date'=>'0','post-author'=>'0','post-category'=>'0','comments'=>'0','views'=>'0','post-excerpt'=>'0');
